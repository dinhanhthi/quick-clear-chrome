...
⏬ Download the latest version [here](https://github.com/dinhanhthi/quick-clear-chrome/releases/download/v1.2.4/quick-clear-chrome-v1.2.4.zip).
...
1. If you just want to use [the latest version](https://github.com/dinhanhthi/quick-clear-chrome/releases/download/v1.2.4/quick-clear-chrome-v1.2.4.zip), extract the zip file from `zip/` folder and load it in Chrome.
