...
⏬ Download the latest version [here](https://github.com/dinhanhthi/quick-clear-chrome/releases/download/v1.4.0/quick-clear-chrome-v1.4.0.zip).
...
1. If you just want to use [the latest version](https://github.com/dinhanhthi/quick-clear-chrome/releases/download/v1.4.0/quick-clear-chrome-v1.4.0.zip), extract the zip file from `zip/` folder and load it in Chrome.
